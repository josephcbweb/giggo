...
const Navbar = async () => {
  ...
  return (
    <nav className=" text-black flex justify-center items-center fixed top-3 w-full z-20">
      <div className="w-4/5 bg-black rounded-3xl p-2 shadow-lg">
        <div className="flex justify-between mx-4">
          <div className="flex items-center">
            <Link className="flex gap-3 items-center h-full" href={"/"}>
              <Image src="/logo-color.png" width={45} height={45} alt="logo" />
              <p className="text-2xl text-white font-semibold relative bottom-1">
                giggo
              </p>
            </Link>
          </div>
            ...
            {session ? (
              <div className="profile">
                ...
                <div className=" gap-6 items-center hidden md:inline-flex">
                  <Link href={"/user/applied"} className="hover:text-teal-400">
                    Applied Jobs
                  </Link>
